...
class Employee(Validator):
    ...
    def add_employee(self):
        employee_item = {}
        employee_item["id"] = self.generate_id("employee")

        while True:
            try:
                e_f_name = input("Enter first name: ")
                if not self.check_name(e_f_name):
        ...
        while True:
            try:
                ...
                if not self.check_name(e_l_name):
        ...
        while True:
            try:
                ...
                if not self.check_jalali_birthdate(e_birth):
        ...
        while True:
            try:
                ...
                if not self.check_gender(e_gender):
    ...
    def edit_employee(self):
        ...
        while True:
            try:
                e_id_input = input("Enter employee id: ")
        ...
        while True:
            try:
                ...
                if e_date_of_birth == "":
                    ...
                    break
                if not self.check_jalali_birthdate(e_date_of_birth):
                    raise ValueError("Enter correct date of birth like --> 1400/02/30")
